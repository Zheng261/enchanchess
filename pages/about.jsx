	     ...
	     <div className={styles.cardContainer}>
	        ...
	        <div className={styles.centerContainer}>
	          <CardDiv>
				...
				Rules can be found <a href="http://s3.amazonaws.com/cah/CAH_Rules.pdf" target="_blank">here</a>. <br />
				This site was developed by Team GGEZ in Spring 2020 for Stanford's CS194 class. We're unaffiliated with the CAH team and all that.<br />
     			</div>
	          </CardDiv>
	        </div>
	        <div>
